...
const TIPS = {
  ...
  // the ceiling; only לא-מזכה does. Texts and code now say one thing.
  takara:
    'התקרה המוצגת היא למשרה מלאה (100%):\n• עובדת רגילה: ₪5,400\n• ותיקה: ₪5,838.25\n\nהתקרה בפועל מחושבת לפי אחוז המשרה החודשי לכל מרפאה:\nאחוז משרה = (שעות תקן − היעדרות לא מזכה + שעות עודפות) ÷ שעות פוטנציאליות\nתקרה בפועל = אחוז המשרה (מעוגל לאחוז שלם) × התקרה המלאה\n\nהיעדרות מזכה לא מקטינה את התקרה; היעדרות לא מזכה (מחלה) כן.',
